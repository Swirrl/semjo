class ArticlesController < ApplicationController
  ...
  def show
    fresh_when(:last_modified => @article.updated_at, :public => true, :etag => @article)
  end
  
  def index 
    if @most_recent_article  
      if stale?(:last_modified => @most_recent_article.updated_at, :public => true, :etag => @most_recent_article)    
  ...
  def feed
    if stale?(:last_modified => (@most_recent_article ? @most_recent_article.updated_at : Time.now), :public => true, :etag => @most_recent_article) 
